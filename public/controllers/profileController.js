angular.module("KnowItAll").controller('ProfileCtrl', ['$scope', '$http', '$cookies', '$location', '$window', '$routeParams', function($scope, $http, $cookies, $location, $window, $routeParams) {
	var username = null;
	var loggedIn = true;
	...
	$http.get('/getUserName?userID=' + userID).then(function(response) {
