...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _content_body = __webpack_require__(160);

	var _content_body2 = _interopRequireDefault(_content_body);

	var _reactFacebookLogin = __webpack_require__(190);
	...
	var URL_server = "http://drone-api-server-stage.herokuapp.com/users/api/v1.0/token";

	/*put the ContentBody in the map-container div */
	var responseFacebook = function responseFacebook(response) {
		console.log("response");
		console.log(response);
		var AuthStr = response.email + response.accessToken;
		...
		var ajax = $.ajax({
			...
			error: function error(xhr, ajaxOptions, throwError) {
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_content_body2.default, null),
					_react2.default.createElement(_reactFacebookLogin2.default, {
						appId: '162536960958481',
						autoLoad: true,
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.querySelector('#map-container'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _DataTable = __webpack_require__(188);
	...
	/*
	content_body will make the request to the server by using Axios, 
	and pass the info of drones (drone state, battery, GPS Location) 
	to its children (google_map and DataTable).
	*/

	var URL = "https://young-woodland-12457.herokuapp.com/drone/api/v1.0/";

	// drone URL
	var URL_drone = URL + "drones";
	...
	var ContentBody = function (_Component) {
		...
		_createClass(ContentBody, [{
			...
			value: function componentDidMount() {
				console.log("parent componentDidMount start");
				var self = this;

				/* read number of available drones */
				_axios2.default.get(URL_drone).then(function (response) {
					self.setState({
						dronesNum: response.data.dronesNum
					});
					console.log("drones number: " + self.state.dronesNum);
				}).then(
				/* read data periodically */
				setInterval(function () {
					/*read drone remaining battery*/
					/*read GPS location*/
					var element = void 0;
					_axios2.default.get(URL_drone).then(function (response) {
						var update_dronesData = [];
						// set GPS location obtained from axios to dronesData
						for (var num = 0; num < self.state.dronesNum; num++) {
							var index = num + '';
							var lat = response.data.drones[index].State.ardrone3.PilotingState.GpsLocationChanged.latitude;
							var lon = response.data.drones[index].State.ardrone3.PilotingState.GpsLocationChanged.longitude;
							var alt = response.data.drones[index].State.ardrone3.PilotingState.GpsLocationChanged.altitude;
							element = {
								key: num,
								lat: lat,
								lon: lon,
							...
							update_dronesData.push(element);
							console.log("AJAX going to update");
							self.setState({
								dronesData: update_dronesData
							});
						}
						console.log("AJAX body--dronesData: ");
						console.log(self.state.dronesData);
					}).catch(function (e) {
			...
			key: 'render',
			value: function render() {
				console.log("this.state.dronesData.length");
				console.log(this.state.dronesData.length);
				if (this.state.dronesData.length > 0) {
					console.log(this.state.dronesData);
				}
				return _react2.default.createElement(
					'div',
					null,
					this.state.dronesData.length > 0 ? _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(_google_map2.default, { dronesNum: this.state.dronesNum,
							dronesData: this.state.dronesData
						}),
						_react2.default.createElement(_DataTable2.default, { dronesData: this.state.dronesData
						})
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// lineCoords.push(new google.maps.LatLng(INITIAL_LOCATION.position.lat, INITIAL_LOCATION.position.lon));
	// lineCoords.push(new google.maps.LatLng(NEW_LOCATION.position.lat, NEW_LOCATION.position.lon));
	...
	var WorldMap = function (_Component) {
	  ...
	  function WorldMap(props) {
	    ...
	    _this.setMapElementReference = function (mapElementReference) {
	      _this.mapElement = mapElementReference;
	    };
	  ...
	  _createClass(WorldMap, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.map = new google.maps.Map(mapElement, {
	        zoom: this.state.INITIAL_ZOOM,
	        center: {
	          // lat: this.state.dronesData ? this.state.dronesData[0].lat : this.state.map_lat,
	          // lng: this.state.dronesData ? this.state.dronesData[0].lon : this.state.map_lon
	          lat: this.state.map_lat,
	          lng: this.state.map_lon
	        }
	      });

	      //path
	      for (var i = 0; i < this.state.dronesNum; i++) {
	        var lineSeg = [];
	        lineCoords.push(lineSeg);
	      }

	      // marker
	      var count = 0;
	      this.state.dronesData.map(function (drone) {
	        lineCoords[count].push(new google.maps.LatLng(drone.lat, drone.lon));
	        var each_marker = new google.maps.Marker({
	          position: {
	            lat: drone.lat,
	            lng: drone.lon
	          },
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      console.log("child componentWillReceiveProps start");
	      console.log("nextProps dronesData:");
	      console.log(nextProps.dronesData);

	      if (nextProps.dronesData) {
	        this.setState({
	          dronesData: nextProps.dronesData
	        });
	      }
	      ...
	      //   self.markers[count].setPosition(latlng);
	      //   count = count + 1;
	      // });
	      ...
	      for (var _i = 0; _i < lineCoords.length; _i++) {
	        var len = lineCoords[_i].length;
	        if (len >= 2) {
	          var seg = new Array(lineCoords[_i][len - 1], lineCoords[_i][len - 2]);
	        } else {
	          var seg = new Array(lineCoords[_i]);
	        }
	        // path
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "map", ref: this.setMapElementReference },
	          " "
	        ),
	        _react2.default.createElement(
	          "div",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TableRow = __webpack_require__(189);
	...
	var DataTable = function (_Component) {
		...
		_createClass(DataTable, [{
			...
			value: function render() {
				var self = this;
				var rows = self.props.dronesData.map(function (drone) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"table",
						{ className: "table table-sm table-hover table-striped info-table" },
						_react2.default.createElement(
							"thead",
							null,
							_react2.default.createElement(
...
/***/ (function(module, exports, __webpack_require__) {
	...
	! function(e, t) {  true ? module.exports = t(__webpack_require__(2)) : "function" == typeof define && define.amd ? define(["react"], t) : "object" == typeof exports ? exports.FacebookLogin = t(require("react")) : e.FacebookLogin = t(e.react) }(this, function(e) { return function(e) {
	    function t(n) { if (o[n]) return o[n].exports; var i = o[n] = { exports: {}, id: n, loaded: !1 }; return e[n].call(i.exports, i, i.exports, t), i.loaded = !0, i.exports } var o = {}; return t.m = e, t.c = o, t.p = "", t(0) }([function(e, t, o) { e.exports = o(2) }, function(e, t, o) { "use strict";
	    ...
	    function a(e, t) { if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
	      ...
	      h = o(3),
	      y = n(h),
	      g = function() { var e = !1; try { e = !!(window.navigator && window.navigator.standalone || navigator.userAgent.match("CriOS") || navigator.userAgent.match(/mobile/i)) } catch (t) {} return e },
	      m = function(e) { return ["button", "input", "select", "textarea", "optgroup", "option", "fieldset"].indexOf((e + "").toLowerCase()) >= 0 },
	      v = function(e) {
	        function t() { var e, o, n, a;
	          i(this, t); for (var c = arguments.length, u = Array(c), l = 0; l < c; l++) u[l] = arguments[l]; return o = n = r(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(u))), n.state = { isSdkLoaded: !1, isProcessing: !1 }, n.responseApi = function(e) { window.FB.api("/me", { locale: n.props.language, fields: n.props.fields }, function(t) { s(t, e), n.props.callback(t) }) }, n.checkLoginState = function(e) { n.setStateIfMounted({ isProcessing: !1 }), e.authResponse ? n.responseApi(e.authResponse) : n.props.callback && n.props.callback({ status: e.status }) }, n.checkLoginAfterRefresh = function(e) { "connected" === e.status ? n.checkLoginState(e) : window.FB.login(function(e) { return n.checkLoginState(e) }, !0) }, n.click = function(e) { if (n.state.isSdkLoaded && !n.state.isProcessing && !n.props.isDisabled) { n.setState({ isProcessing: !0 }); var t = n.props,
	                o = t.scope,
	                i = t.appId,
	                r = t.onClick,
	                a = t.reAuthenticate,
	                s = t.redirectUri,
	                c = t.disableMobileRedirect; if ("function" != typeof r || (r(e), !e.defaultPrevented)) { var u = { client_id: i, redirect_uri: s, state: "facebookdirect", scope: o };
	                a && (u.auth_type = "reauthenticate"), n.props.isMobile && !c ? window.location.href = "//www.facebook.com/dialog/oauth?" + (0, y["default"])(u) : window.FB.login(n.checkLoginState, { scope: o, auth_type: u.auth_type }) } } }, a = o, r(n, a) } return a(t, e), c(t, [{ key: "componentDidMount", value: function() { if (this._isMounted = !0, document.getElementById("facebook-jssdk")) return void this.sdkLoaded();
	            this.setFbAsyncInit(), this.loadSdkAsynchronously(); var e = document.getElementById("fb-root");
	            e || (e = document.createElement("div"), e.id = "fb-root", document.body.appendChild(e)) } }, { key: "componentWillUnmount", value: function() { this._isMounted = !1 } }, { key: "setStateIfMounted", value: function(e) { this._isMounted && this.setState(e) } }, { key: "setFbAsyncInit", value: function() { var e = this,
	              t = this.props,
	              o = t.appId,
	              n = t.xfbml,
	              i = t.cookie,
	              r = t.version,
	              a = t.autoLoad;
	            window.fbAsyncInit = function() { window.FB.init({ version: "v" + r, appId: o, xfbml: n, cookie: i }), e.setStateIfMounted({ isSdkLoaded: !0 }), (a || window.location.search.includes("facebookdirect")) && window.FB.getLoginStatus(e.checkLoginAfterRefresh) } } }, { key: "sdkLoaded", value: function() { this.setState({ isSdkLoaded: !0 }) } }, { key: "loadSdkAsynchronously", value: function() { var e = this.props.language;! function(t, o, n) { var i = t.getElementsByTagName(o)[0],
	                r = i,
	                a = i;
	              t.getElementById(n) || (a = t.createElement(o), a.id = n, a.src = "https://connect.facebook.net/" + e + "/all.js", r.parentNode.insertBefore(a, r)) }(document, "script", "facebook-jssdk") } }, { key: "style", value: function() { var e = this.constructor.defaultProps.cssClass; return this.props.cssClass === e && l["default"].createElement("style", { dangerouslySetInnerHTML: { __html: b["default"] } }) } }, { key: "containerStyle", value: function() { var e = { transition: "opacity 0.5s" }; return (this.state.isProcessing || !this.state.isSdkLoaded || this.props.isDisabled) && (e.opacity = .6), s(e, this.props.containerStyle) } }, { key: "render", value: function() { var e = this.props,
	              t = e.cssClass,
	              o = e.size,
	              n = e.icon,
	              i = e.textButton,
	              ...
	              a = e.buttonStyle,
	              c = "string" == typeof n,
	              u = {}; return this.props.isDisabled && m(this.props.tag) && (u.disabled = !0), l["default"].createElement("span", { style: this.containerStyle() }, c && l["default"].createElement("link", { rel: "stylesheet", href: "//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" }), l["default"].createElement(this.props.tag, s({ type: r, className: t + " " + o, style: a, onClick: this.click }, u), n && c && l["default"].createElement("i", { className: "fa " + n }), n && !c && n, i), this.style()) } }]), t }(l["default"].Component);
	    v.propTypes = { isDisabled: d["default"].bool, callback: d["default"].func.isRequired, appId: d["default"].string.isRequired, xfbml: d["default"].bool, cookie: d["default"].bool, reAuthenticate: d["default"].bool, scope: d["default"].string, redirectUri: d["default"].string, textButton: d["default"].string, typeButton: d["default"].string, autoLoad: d["default"].bool, disableMobileRedirect: d["default"].bool, isMobile: d["default"].bool, size: d["default"].string, fields: d["default"].string, cssClass: d["default"].string, version: d["default"].string, icon: d["default"].any, language: d["default"].string, onClick: d["default"].func, containerStyle: d["default"].object, buttonStyle: d["default"].object, tag: d["default"].oneOfType([d["default"].node, d["default"].func]) }, v.defaultProps = { textButton: "Login with Facebook", typeButton: "button", redirectUri: "undefined" != typeof window ? window.location.href : "/", scope: "public_profile,email", xfbml: !1, cookie: !1, reAuthenticate: !1, size: "metro", fields: "name", cssClass: "kep-login-facebook", version: "2.3", language: "zh_TW", disableMobileRedirect: !1, isMobile: g(), tag: "button" }, t["default"] = v }, function(e, t, o) { "use strict";

	    function n(e) { return e && e.__esModule ? e : { "default": e } } Object.defineProperty(t, "__esModule", { value: !0 }), t["default"] = void 0; var i = o(1),
	      r = n(i);
	    t["default"] = r["default"] }, function(e, t) { "use strict";
	    Object.defineProperty(t, "__esModule", { value: !0 }), t["default"] = function(e) { var t = ""; for (var o in e) "" !== t && (t += "&"), t += o + "=" + encodeURIComponent(e[o]); return t } }, function(e, t, o) { t = e.exports = o(5)(), t.push([e.id, ".kep-login-facebook{font-family:Helvetica,sans-serif;font-weight:700;-webkit-font-smoothing:antialiased;color:#fff;cursor:pointer;display:inline-block;font-size:calc(.27548vw + 12.71074px);text-decoration:none;text-transform:uppercase;transition:background-color .3s,border-color .3s;background-color:#4c69ba;border:calc(.06887vw + .67769px) solid #4c69ba;padding:calc(.34435vw + 13.38843px) calc(.34435vw + 18.38843px)}.kep-login-facebook.small{padding:calc(.34435vw + 3.38843px) calc(.34435vw + 8.38843px)}.kep-login-facebook.medium{padding:calc(.34435vw + 8.38843px) calc(.34435vw + 13.38843px)}.kep-login-facebook.metro{border-radius:0}.kep-login-facebook .fa{margin-right:calc(.34435vw + 3.38843px)}", ""]), t.locals = { "kep-login-facebook": "kep-login-facebook", small: "small", medium: "medium", metro: "metro", fa: "fa" } }, function(e, t) { e.exports = function() { var e = []; return e.toString = function() { for (var e = [], t = 0; t < this.length; t++) { var o = this[t];
	          o[2] ? e.push("@media " + o[2] + "{" + o[1] + "}") : e.push(o[1]) } return e.join("") }, e.i = function(t, o) { "string" == typeof t && (t = [
	          [null, t, ""]
	        ]); for (var n = {}, i = 0; i < this.length; i++) { var r = this[i][0]; "number" == typeof r && (n[r] = !0) } for (i = 0; i < t.length; i++) { var a = t[i]; "number" == typeof a[0] && n[a[0]] || (o && !a[2] ? a[2] = o : o && (a[2] = "(" + a[2] + ") and (" + o + ")"), e.push(a)) } }, e } }, function(e, t) { "use strict";

	    function o(e) { return function() { return e } } var n = function() {};
	    n.thatReturns = o, n.thatReturnsFalse = o(!1), n.thatReturnsTrue = o(!0), n.thatReturnsNull = o(null), n.thatReturnsThis = function() { return this }, n.thatReturnsArgument = function(e) { return e }, e.exports = n }, function(e, t, o) { "use strict";

	    function n(e, t, o, n, r, a, s, c) { if (i(t), !e) { var u; if (void 0 === t) u = new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
	        else { var l = [o, n, r, a, s, c],
	            f = 0;
	          u = new Error(t.replace(/%s/g, function() { return l[f++] })), u.name = "Invariant Violation" } throw u.framesToPop = 1, u } } var i = function(e) {};
	    e.exports = n }, function(e, t, o) { "use strict"; var n = o(6),
	      i = o(7),
	      r = o(10);
	    e.exports = function() {
	      function e(e, t, o, n, a, s) { s !== r && i(!1, "Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types") }

	      function t() { return e } e.isRequired = e; var o = { array: e, bool: e, func: e, number: e, object: e, string: e, symbol: e, any: e, arrayOf: t, element: e, instanceOf: t, node: e, objectOf: t, oneOf: t, oneOfType: t, shape: t }; return o.checkPropTypes = n, o.PropTypes = o, o } }, function(e, t, o) { e.exports = o(8)() }, function(e, t) { "use strict"; var o = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED";
	    e.exports = o }, function(t, o) { t.exports = e }]) });
